...
const FACTION_PALETTES: Record<string, { color: string; foil: string; paletteLabel: string }> = {
  ...
  "The Viper · Evolution": { color: "#2d164d", foil: "#10b981", paletteLabel: "Viper Độc Xà · RKO Outta Nowhere" },
  "Rated-R Superstar · TLC Master": { color: "#450a0a", foil: "#ef4444", paletteLabel: "Rated-R Huyết Diễm · Spear Hủy Diệt" },
  "D-Generation X · Showstopper": { color: "#052e16", foil: "#22c55e", paletteLabel: "DX Huỳnh Quang · Sweet Chin Music" },
  "Straight Edge Society · Cult of Personality": { color: "#18181b", foil: "#f43f5e", paletteLabel: "Straight Edge Hắc Thiết · GTS" },
  "The Undefeated Streak · WCW Legend": { color: "#172554", foil: "#e2e8f0", paletteLabel: "Kỷ Lục Bất Bại · Jackhammer" },
  "The Hardy Boyz · Team Xtreme": { color: "#2e1065", foil: "#06b6d4", paletteLabel: "Team Xtreme Tử Lam · Swanton Bomb" },
  "The Hardy Boyz · Broken Universe": { color: "#064e3b", foil: "#a855f7", paletteLabel: "Broken Universe U Hồn · Delete" },
  "Harlem Heat · King Booker": { color: "#78350f", foil: "#eab308", paletteLabel: "King Booker Hoàng Kim · Spinaroonie" },
  "Lucha Libre World · The Lucha Dragons": { color: "#047857", foil: "#fbbf24", paletteLabel: "Lucha Phi Long · Vô Ảnh Nhào Lộn" },
  "The Nexus · King of the Ring": { color: "#18181b", foil: "#ef4444", paletteLabel: "The Nexus Hắc Hồng · Bullhammer" },
  "The All Mighty · The Hurt Business": { color: "#1c1917", foil: "#eab308", paletteLabel: "Hắc Kim Hộ Pháp · The Hurt Lock" },
  "Bottomless Pit · Supernatural Horror": { color: "#300b0b", foil: "#dc2626", paletteLabel: "Kinh Dị Đêm Đen · Boogey Slam" },
  "Finlay's Clan · Little Bastard": { color: "#064e3b", foil: "#84cc16", paletteLabel: "Lục Bảo Ireland · Small But Fierce" },
  "The Rhodes Dynasty · Golden Era": { color: "#1c1917", foil: "#ffd700", paletteLabel: "Bizarre Gold · Curtain Call" },
  "Hulkamania · nWo Hollywood": { color: "#851e1e", foil: "#facc15", paletteLabel: "Hulkamania Hoàng Đỏ · Bất Tử" },
  "Superhero Universe · Cruiserweight Elite": { color: "#064e3b", foil: "#4ade80", paletteLabel: "Thần Phong Lục · Stand Back" },
  "Y2J · The Jericho Appreciation Society": { color: "#2e1065", foil: "#fbbf24", paletteLabel: "Tử Kim Y2J · Codebreaker" },
  "nWo (New World Order) · The Kliq": { color: "#0a0a0a", foil: "#ffffff", paletteLabel: "nWo Hắc Bạch · Jackknife Powerbomb" },
  "The New Day · Power of Positivity": { color: "#0284c7", foil: "#f43f5e", paletteLabel: "Lam Hồng Cầu Vồng · Trouble In Paradise" },
  "Awesome Truth · What's Up Movement": { color: "#18181b", foil: "#eab308", paletteLabel: "Hắc Kim Phá Cách · What's Up?!" },
  "Too Cool · Samoan Dynasty": { color: "#78350f", foil: "#fbbf24", paletteLabel: "Samoa Hoàng Kim · Stinkface" },
  "The Big Guy · RybAxel": { color: "#3b0764", foil: "#ef4444", paletteLabel: "Cuồng Nộ Cơ Bắp · Shell Shocked" },
  "The Shield · The Visionary": { color: "#1e1b4b", foil: "#fbbf24", paletteLabel: "Tử Lam Hắc Giáp · The Stomp" },
  "The Hurt Business · The World's Greatest Tag Team": { color: "#172554", foil: "#38bdf8", paletteLabel: "The Standard Băng Lam · T-Bone" },
  "The Crow · WCW Franchise": { color: "#09090b", foil: "#e4e4e7", paletteLabel: "Quạ Đen Bạch Dạ · Scorpion Deathlock" },
  "Toryumon · Cruiserweight Dragon": { color: "#0c4a6e", foil: "#38bdf8", paletteLabel: "Thanh Long Lam · Asai Moonsault" },
  "Giant Dominance · The World's Largest Athlete": { color: "#1c1917", foil: "#f59e0b", paletteLabel: "Hắc Kim Cự Thể · KO Punch (WMD)" },
  "The Beast Incarnate · Suplex City": { color: "#450a0a", foil: "#ef4444", paletteLabel: "Huyết Diễm Quái Thú · Suplex City" },
  "Brothers of Destruction · Hellfire": { color: "#3f0000", foil: "#ff2200", paletteLabel: "Địa Ngục Hỏa Xích · Hellfire Chokeslam" },
  "Punjabi Titans · Indian Giant": { color: "#2e1065", foil: "#fbbf24", paletteLabel: "Tử Kim Punjab · Khali Vise Grip" },
  "Team Angle · The Wrestling Machine": { color: "#172554", foil: "#ef4444", paletteLabel: "Tinh Kỳ Mỹ Quốc · Olympic Ankle Lock" },
  "Hall of Pain · World's Strongest": { color: "#18181b", foil: "#dc2626", paletteLabel: "Hall of Pain · World's Strongest Slam" },
  ...
  "The O.C. · The Phenomenal One": { color: "#0c1e3d", foil: "#38bdf8", paletteLabel: "Phenomenal Lam · Băng Phong · Styles Clash" },
  "The Wyatt Family · Firefly Fun House": { color: "#1c1408", foil: "#f97316", paletteLabel: "U Minh Hỏa · Firefly · Sister Abigail" },
  "The Hart Foundation · Canadian Excellence": { color: "#2d0b1a", foil: "#ec4899", paletteLabel: "Hồng Hắc · Canadian Hitman · Sharpshooter" },
  "The Judgment Day · Demon King": { color: "#260a2d", foil: "#c084fc", paletteLabel: "Ác Ma Tử Huyết · Coup de Grâce" },
  "Lucha House Party · Lucha Libre World": { color: "#044e3b", foil: "#facc15", paletteLabel: "Lucha Hoàng Lục · Vua Dây Đài" },
  "The Cabinet · APA": { color: "#291805", foil: "#d97706", paletteLabel: "Tài Phiệt Hổ Phách · Clothesline" },
  "The Usos · The Bloodline Renegade": { color: "#0f172a", foil: "#38bdf8", paletteLabel: "Main Event Lam Hắc · YEET" },
  "The Lucha Dragons · Lucha House Party": { color: "#064e3b", foil: "#22c55e", paletteLabel: "Phi Long Lục Bảo · Salida del Sol" },
  "The Megastar · YEAH! Movement": { color: "#18181b", foil: "#eab308", paletteLabel: "Megastar Hoàng Kim · YEAH!" },
  "The Maverick · PRIME Energy": { color: "#09090b", foil: "#06b6d4", paletteLabel: "PRIME Lam Điện · The Maverick" },
  "The Four Horsemen · Evolution": { color: "#451a03", foil: "#fbbf24", paletteLabel: "Nature Boy Kim Điệp · WOOOO!" },
  "ECW Originals · Hardcore Revolution": { color: "#1c1917", foil: "#ef4444", paletteLabel: "Hardcore Bụi Bặm · Sandman" },
  "The New Bloodline · Samoan Dynasty": { color: "#3f0a0a", foil: "#dc2626", paletteLabel: "Tribal Huyết Xích · Samoan Spike" },
  "The People's Champion · The Bloodline High Council": { color: "#18181b", foil: "#f59e0b", paletteLabel: "Bá Vương Hoàng Kim · Rock Bottom" },
  "Parts Unknown · Warrior Nation": { color: "#701a75", foil: "#f43f5e", paletteLabel: "Chiến Binh Cuồng Nộ · Warrior Splash" },
  "Ministry of Darkness · The Deadman": { color: "#090514", foil: "#a855f7", paletteLabel: "Hắc Dạ Tử Khí · Tombstone Piledriver" },
  "The New Day · UpUpDownDown": { color: "#0369a1", foil: "#fbbf24", paletteLabel: "Du Hí Hoàng Lam · Francesca Trombone" },
